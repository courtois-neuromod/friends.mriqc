...
#SBATCH --job-name=mriqc_study-friends_sub-03_ses-050.job
#SBATCH --output=./code/mriqc_study-friends_sub-03_ses-050.out
#SBATCH --error=./code/mriqc_study-friends_sub-03_ses-050.err
#SBATCH --time=8:00:00
...
datalad containers-run -m 'mriqc_sub-03/ses-050' -n containers/bids-mriqc --input sourcedata/friends/sub-03/ses-050/fmap/ --input sourcedata/friends/sub-03/ses-050/func/ --output . -- -w workdir/ --participant-label 03 --session-id 050 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/friends ./ participant 
mriqc_exitcode=$?
