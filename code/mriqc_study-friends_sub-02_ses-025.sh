...
#SBATCH --job-name=mriqc_study-friends_sub-02_ses-025.job
#SBATCH --output=./code/mriqc_study-friends_sub-02_ses-025.out
#SBATCH --error=./code/mriqc_study-friends_sub-02_ses-025.err
#SBATCH --time=8:00:00
...
datalad containers-run -m 'mriqc_sub-02/ses-025' -n containers/bids-mriqc --input sourcedata/friends/sub-02/ses-025/fmap/ --input sourcedata/friends/sub-02/ses-025/func/ --output . -- -w workdir/ --participant-label 02 --session-id 025 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/friends ./ participant 
mriqc_exitcode=$?
