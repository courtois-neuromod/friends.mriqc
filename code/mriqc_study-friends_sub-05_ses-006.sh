...
#SBATCH --job-name=mriqc_study-friends_sub-05_ses-006.job
#SBATCH --output=./code/mriqc_study-friends_sub-05_ses-006.out
#SBATCH --error=./code/mriqc_study-friends_sub-05_ses-006.err
#SBATCH --time=8:00:00
...
datalad containers-run -m 'mriqc_sub-05/ses-006' -n containers/bids-mriqc --input sourcedata/friends/sub-05/ses-006/fmap/ --input sourcedata/friends/sub-05/ses-006/func/ --output . -- -w workdir/ --participant-label 05 --session-id 006 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/friends ./ participant 
mriqc_exitcode=$?
