...
#SBATCH --job-name=mriqc_study-friends_sub-05_ses-010.job
#SBATCH --output=./code/mriqc_study-friends_sub-05_ses-010.out
#SBATCH --error=./code/mriqc_study-friends_sub-05_ses-010.err
#SBATCH --time=8:00:00
...
datalad containers-run -m 'mriqc_sub-05/ses-010' -n containers/bids-mriqc --input sourcedata/friends/sub-05/ses-010/fmap/ --input sourcedata/friends/sub-05/ses-010/func/ --output . -- -w workdir/ --participant-label 05 --session-id 010 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/friends ./ participant 
mriqc_exitcode=$?
