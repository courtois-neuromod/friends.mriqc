...
#SBATCH --job-name=mriqc_study-friends_sub-03_ses-046.job
#SBATCH --output=./code/mriqc_study-friends_sub-03_ses-046.out
#SBATCH --error=./code/mriqc_study-friends_sub-03_ses-046.err
#SBATCH --time=8:00:00
...
datalad containers-run -m 'mriqc_sub-03/ses-046' -n containers/bids-mriqc --input sourcedata/friends/sub-03/ses-046/fmap/ --input sourcedata/friends/sub-03/ses-046/func/ --output . -- -w workdir/ --participant-label 03 --session-id 046 --omp-nthreads 8 --nprocs 8 -m bold --mem_gb 32 --no-sub sourcedata/friends ./ participant 
mriqc_exitcode=$?
